  ...
  render () {
    if (this.state && this.state.data) {
      ...
      if (methodObject.lead_image) {
        var pic = awsUrl + encodeURIComponent(methodObject.lead_image.url);
      }
      if (methodObject.other_images.length) {
        var otherImg = awsUrl + encodeURIComponent(methodObject.other_images[0].url);
      }
              ...
              <Row>
                ...
                <Col md='8' xs='12' className='main-area'>
                  <div className='case-box'>
                    ...
                    <div className='case-html' dangerouslySetInnerHTML={{__html: methodObject.body}} />
                  </div>
                </Col>
