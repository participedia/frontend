        ...
        <Row>
          <Col lg={{ size: 10, offset: 1 }}>
            ...
            <div className="accordion">
              <AccordionTab
                title={this.props.intl.formatMessage({ id: "explore" })}
              >
                <div className="content">
                  <p className="text">
                    {this.props.intl.formatMessage({ id: "explore_intro" })}
                  </p>
                </div>
              </AccordionTab>
              <AccordionTab
              ...
              >
                <div className="content">
                  <p className="text">
                    {this.props.intl.formatMessage({ id: "create_intro" })}
                  </p>
                </div>
              </AccordionTab>
            </div>
            ...
            <div className="text">
              {this.props.intl.formatMessage({ id: "community_intro" })}
            </div>
            <div className="accordion">
              <AccordionTab
              ...
              >
                <div className="content">
                  <p className="text">
                    ...
                    <a className="people" href="#">
                      {this.props.intl.formatMessage({ id: "pat_scully" })}
                    </a>
                    <a className="people" href="#">
                      {this.props.intl.formatMessage({ id: "jesi_carson" })}
                    </a>
                  </p>
                </div>
              </AccordionTab>
                  ...
                  <div className="sub-accordion">
                    ...
                    >
                      <div className="sub-content">
                        <p className="name">
                          {this.props.intl.formatMessage({ id: "marco_adria" })}
                        </p>
                        ...
                        <p className="name">
                          {this.props.intl.formatMessage({ id: "amber_frid" })}
                        </p>
                        <p className="department">
                          {this.props.intl.formatMessage({
                            id: "amber_frid_dept"
                        ...
                        <p className="name">
                          {this.props.intl.formatMessage({ id: "archon_fung" })}
                        </p>
                        <p className="department">
                          {this.props.intl.formatMessage({
                            id: "archon_fung_dept"
                        ...
                        <p className="department">
                          {this.props.intl.formatMessage({
                            id: "graham_smith_dept"
                          })}
                        </p>
                        <p className="name">
                          {this.props.intl.formatMessage({ id: "bettina_von" })}
                        </p>
                        <p className="department">
                          {this.props.intl.formatMessage({
                            id: "bettina_von_dept"
                        ...
                        <p className="name">
                          {this.props.intl.formatMessage({ id: "mark_warren" })}
                        </p>
                        <p className="department">
                          {this.props.intl.formatMessage({
                            id: "mark_warren_dept"
              ...
              >
                <div className="content">
                  <p className="text">
                    {this.props.intl.formatMessage({ id: "funders_intro" })}
                  </p>
                </div>
              </AccordionTab>
              <AccordionTab
            ...
            <div className="accordion">
              ...
              >
                <div className="content">
                  <p className="text">
                    {this.props.intl.formatMessage({ id: "surveys_content" })}
                  </p>
                </div>
              </AccordionTab>
              <AccordionTab
                title={this.props.intl.formatMessage({ id: "datasets" })}
              >
                <div className="content">
                  <p className="text">
                    {this.props.intl.formatMessage({ id: "datasets_content" })}.
                  </p>
                </div>
              </AccordionTab>
              <AccordionTab
