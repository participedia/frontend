...
class QuickSubmit extends React.Component {
  ...
  render() {
    return (
      <ItemForm {...this.props} onSubmit={this.handleSubmit}/>
    )
  }
}
...
let CaseForm = connect(mapStateToProps, mapDispatchToProps)(redform(_QuickCase))
let MethodForm = connect(mapStateToProps, mapDispatchToProps)(redform(_QuickMethod))
let OrganizationForm = connect(mapStateToProps, mapDispatchToProps)(redform(_QuickOrganization))
let DatasetForm = connect(mapStateToProps, mapDispatchToProps)(redform(_QuickDataset))
let SurveyForm = connect(mapStateToProps, mapDispatchToProps)(redform(_QuickSurvey))
