...
class CaseForm extends Component {
  ...
  render() {
    ...
    let parts = [];
    let prefix = (
      <TextField {...firstName} key="firstname" hintText="First Name" />
    );
    parts.push(prefix);
    ...
    parts.push(
      this.makeFormBit({
        ...
        choices: [
          ...
          [
            "This process did NOT involve discussion among participants (for instance, it was an artistic or creative process, or involved individualized action, such as signing a petition)",
            "neither"
          ]
        ]
      })
    ...
    parts.push(
      this.makeFormBit({
        ...
        choices: [
          ...
          [
            "The purpose was to make a decision (for instance, to make policy decisions or recommendations).",
            "decide"
          ]
        ]
      })
    ...
    parts.push(
      this.makeFormBit({
        ...
        choices: [
          [
            "The participants acted as decision-makers, and made binding decisions for the larger public. In other words, the decisions made in this process directly translated into law.",
            "1"
          ],
          [
            "The participants worked with decision-makers (for instance, government officials) to make decisions or provide social services, such as through participatory budgeting, local partnership boards, or community policing.",
            "2"
          ],
          [
            "The participants did not work directly with decision-makers. But they came up with recommendations for consultative purposes. For example, recommendations for the general public to think about, or vote on, recommendations for a government agency, or for a non-governmental organization.",
            "3"
          ],
          [
            "The participants did NOT make policy decisions or recommendations.",
            "4"
          ]
        ]
      })
